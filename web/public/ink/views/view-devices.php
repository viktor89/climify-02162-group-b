...
<div class="single-view view-devices">
    ...
    <div class="map-wrapper map-wrapper-admin">
        <iframe src="http://grafana.se2-webapp02.compute.dtu.dk/d-solo/fN_AzXbik/skoleklima?refresh=5s&orgId=1&panelId=2&from=1540879984159&to=1540901584159" width="100%" height="500" frameborder="0"></iframe>
    </div>
